			...
			<div class="flex-w flex-tr">
				...
				<div class="" style="width: 100%; height:100%;">
						<div class="p-lr-25 p-t-55 p-b-70 BGimage" style="width: 100%; height:100%;">
                            <h1 style="font-weight: 600;">Forgot your password ?</h1>
                            <p style="font-size: 18px; text-align: center;">Enter your e-mail address and we'll send a code to reset your password</p>
                        </div>
					</div>
				</div>
