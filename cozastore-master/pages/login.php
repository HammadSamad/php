			...
			<div class="flex-w flex-tr">
				...
				<div class="" style="width: 100%; height:100%;">
						<div class="p-lr-25 p-t-55 p-b-70 BGimage" style="width: 100%; height:100%;">
                            ...
                            <p style="font-size: 18px; text-align: center;">To keep connected with us please login with your personal info</p>
                            
                            <a href="signup.php" class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04 text-center" style="margin-top: 1rem; color:white; cursor:pointer;">
                            Create an Account
							</a>
                        </div>
					</div>
					...
					<div class="p-t-33">
                            <form method="POST">
                                <div class="form-group">
                                    ...
                                    <small id="emailHelp" class="form-text text-muted" style="font-size: 11px;">We'll never share your email with anyone else.</small>
                                </div>
                                <div class="form-group">
                                ...
                                <p class="text-center p-t-13"><a href="forgotPassEmail.php">Forgot Password?</a></p>
                            </form>
