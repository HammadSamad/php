<!-- email wala session destroy karna hai -->
...
if(isset($_POST['Btn']))
{
	$forgotPass = $_POST['password'];
    $confirmPass = $_POST['confirmPass'];

    if($forgotPass!= $confirmPass)
    {
	...
	$updatePassQuery = "UPDATE `users` SET `password_hash`= :pass WHERE `user_id` = :userId";
			...
			<div class="flex-w flex-tr">
				...
				<div class="" style="width: 100%; height:100%;">
						<div class="p-lr-25 p-t-55 p-b-70 BGimage" style="width: 100%; height:100%;">
                            ...
                            <p style="font-size: 18px; text-align: center;">Choose a strong new password to secure your account.</p>
                            
                            <!-- <a href="singup.php" class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04 text-center" style="margin-top: 1rem; color:white; cursor:pointer;">
                            Create an Account
							</a> -->
                        </div>
					</div>
					...
					<div class="p-t-33">
                            <form method="POST">
                                <div class="form-group">
                                    ...
                                    <input type="password" name="password" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="New Password" required>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1">Confirm Password</label>
                                    <input type="password" name="confirmPass" class="form-control" id="exampleInputPassword1" placeholder="*********" required>
                                </div>
                                ...
                                <!-- <p class="text-center p-t-13"><a href="forgotPassword.php">Forgot Password?</a></p> -->
                            </form>
