...
<div class="container-scroller">
  ...
  <?php
  //  require "../partials/lightnavbar.php" 
   ?>
  <!-- partial -->
...
if(isset($_POST['btn']))
{
  ...
  if ($slideImage['size'] < 5000000) {
    $ext = explode('.', $slideImage['name']);
    $ext = $ext[1];
    $imageUniqueName = uniqid();
    $imageName = $imageUniqueName. '.'. $ext;
    move_uploaded_file($slideImage['tmp_name'],"../images/" . $imageName);
                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <input type="file" name="slideImage" class="file-upload">
