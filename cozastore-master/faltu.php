...
if (isset($_POST['Btn'])) {
    ...
    if(!$ordersData && !isset($_SESSION['alert_shown'])){
        echo "<script>
            alert('No orders found');
            window.location.reload();
        </script>";
        $_SESSION['alert_shown'] = true; // Session variable set karo
    }
    if(!$ordersData && !isset($_GET['alert_shown'])){
        echo "<script>
            alert('No orders found');
        </script>";
    }else{
    ...
    // if(!$ordersData){
    //    echo "<script>alert('No orders found');window.location.reload();</script>";
    // }else{
                ...
                <div class="row">
                    <div class="column">
                        ...
                        <ul>
                            ...
                            <li><strong>Card Number:</strong> <?= htmlspecialchars($userData['cardNumber']) ?></li>
                            <?php } ?>
