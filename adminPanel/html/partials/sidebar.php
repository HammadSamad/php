...
$rolePermissionQuery = "SELECT * FROM `permissions` JOIN `permission_role` ON permissions.permissions_id = permission_role.permission_id WHERE permission_role.role_id = :roleId";
