...
$viewOrders = "SELECT count(order_id) AS orders FROM `orders`";
$viewOrdersPrepare = $connect->prepare($viewOrders);
$viewOrdersPrepare->execute();
$viewOrdersData = $viewOrdersPrepare->fetch(PDO::FETCH_ASSOC);


$viewUsers = "SELECT count(user_id) AS users FROM `users` WHERE role_id  = 2";
$viewUsersPrepare = $connect->prepare($viewUsers);
$viewUsersPrepare->execute();
$viewUsersData = $viewUsersPrepare->fetch(PDO::FETCH_ASSOC);
?>
                    ...
                    <div class="col-lg-6 col-md-12 col-6 mb-4">
                      <div class="card">
                        <div class="card-body">
                          ...
                          <h3 class="card-title mb-2"><?=$viewOrdersData['orders']?></h3>
                    ...
                    <div class="col-lg-6 col-md-12 col-6 mb-4">
                      <div class="card">
                        <div class="card-body">
                          ...
                          <span>Sales</span>
                          <h3 class="card-title text-nowrap mb-1">$<?=$viewSalesData['sales']?></h3>
                    ...
                    <div class="col-6 mb-4">
                      <div class="card">
                        <div class="card-body">
                          ...
                          <h3 class="card-title text-nowrap mb-2"><?=$viewUsersData['users']?></h3>
