          ...
          if(empty($_POST['countryName'])){
            ...
            else
            {
              ...
              if (!preg_match("/^[A-Za-z ]+$/", $cityName)) {
                ...
                $cityQuery= "INSERT INTO `cities`(`city_name` , `country_id`) VALUES (:cityName , :countryId)";

                $cityprepare = $connect->prepare($cityQuery);
                $cityprepare->bindParam(':cityName',$cityName,PDO::PARAM_STR);
                $cityprepare->bindParam(':countryId',$countryId,PDO::PARAM_STR);

                if($cityprepare->execute()){
                      ...
                      <form id="formAccountSettings" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3 col-md-12">
                            ...
                            <select id="country" class="select2 form-select" name="countryName">
                              <option disabled selected>Choose an Country</option>
                        ...
                        <div class="mt-2">
                          <button type="submit" class="btn btn-primary me-2" name="btn">Add City</button>
