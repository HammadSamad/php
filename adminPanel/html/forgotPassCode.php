        ...
        <div class="authentication-inner py-4">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <p class="mb-4">Enter code we'll send you on <?=$userEmail?></p>
              <form id="formAuthentication" class="mb-3" method="POST">
                ...
                <button name="btn" class="btn btn-primary d-grid w-100">Verify</button>
              </form>
              <div class="text-center">
                <a href="forgotPassEmail.php" class="d-flex align-items-center justify-content-center">
