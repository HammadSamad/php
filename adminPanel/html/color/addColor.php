...
<?php
  ...
  else
  {
    ...
    $ColorQuery= "INSERT INTO `colors`(`color_name`) VALUES (:color_name)";

    $countryprepare = $connect->prepare($ColorQuery);
    $countryprepare->bindParam(':color_name',$ColorName,PDO::PARAM_STR);
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  <div class="card mb-4">
                    <h5 class="card-header">Add colour </h5>
                    <!-- Account -->
                    ...
                    <div class="card-body">
                      <form id="formAccountSettings" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mt-2">
                          <button type="submit" class="btn btn-primary me-2" name="btn">Add colour </button>
