...
if(isset($_POST['btn'])){
  if(!empty($_POST['categoryName'])){
    ...
    if (!preg_match("/^[A-Za-z ]+$/", $categoryName)) {
      ...
      $categoryQuery= "INSERT INTO `categories`(`category_name`,`category_image`) VALUES (:categoryName,:category_image)";

      $categoryprepare = $connect->prepare($categoryQuery);
      $categoryprepare->bindParam(':categoryName',$categoryName,PDO::PARAM_STR);
      $categoryprepare->bindParam(':category_image',$imageName,PDO::PARAM_STR);
...
.pric input[type="number"]::-webkit-inner-spin-button{
                    ...
                    <div class="card-body">
                      <form id="formAccountSettings" method="POST" enctype="multipart/form-data">
                        <div class="row">
                          ...
                          <div class="mb-3 col-md-12">
                            <label for="language" class="form-label">Category Image</label>
                        ...
                        <div class="mt-2">
                          <button type="submit" class="btn btn-primary me-2" name="btn">Add Category</button>
  ...
  form.addEventListener("submit", function(event) {
    // Get category name input value
    const categoryName = document.getElementById("firstName").value;

    // Define a regex pattern for the category name (example: only letters and spaces)
    ...
    if(categoryName == "")
    {
      ...
      alert("Category Name should only contain letters and spaces!");
