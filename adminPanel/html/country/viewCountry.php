                  ...
                  <table class="table table-striped">
                    ...
                    <tbody class="table-border-bottom-0">
                        ...
                        foreach($countryData as $data){
                            ...
                            <tr>
                                <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong><?= $data['country_id'] ?></strong></td>
                                ...
                                <div class="dropdown">
                                    ...
                                    <a class="dropdown-item" href="editCountry.php?id=<?= $data['country_id'] ?>"
                                        ><i class="bx bx-edit-alt me-1"></i> Edit</a
                                    >
                                    <a class="dropdown-item" href="deleteCountry.php?id=<?= $data['country_id'] ?>"
