...
$viewCreditCardQuery = "SELECT * FROM `creditcard` WHERE `creditCardId` = :id";
$viewCreditCardPrepare = $connect->prepare($viewCreditCardQuery);
$viewCreditCardPrepare->bindParam(':id', $id, PDO::PARAM_INT);
$viewCreditCardPrepare->execute();
$CreditCardData = $viewCreditCardPrepare->fetch(PDO::FETCH_ASSOC);
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $creditQuery = "UPDATE `creditcard` SET `cardNumber` = :cardNumber, `cvv` = :cvv, `expiryDate` = :expiryDate, `user_id` = :user_id WHERE `creditCardId` = :id";
    ...
    $creditprepare->bindParam(':id', $id, PDO::PARAM_INT); // Make sure it's an integer
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  <div class="card mb-4">
                    <h5 class="card-header">Edit Credit Card Details</h5>
                    <!-- Account -->
                    ...
                    <div class="card-body">
                      <form id="formAccountSettings" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mt-2">
                          <button type="submit" class="btn btn-primary me-2" name="btn">Eidt Credit Card</button>
